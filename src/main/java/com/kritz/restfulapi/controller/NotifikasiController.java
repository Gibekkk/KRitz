...
//     @DeleteMapping
//     public ResponseEntity<Object> deleteNotification(HttpServletRequest request, @RequestBody HapusNotifikasiDTO hapusNotifikasiDTO) {
//         String sessionToken = request.getHeader("Token");
//         HTTPCode httpCode = HTTPCode.OK;
//         try {
//             if (loginService.checkSessionAlive(sessionToken)) {
...
//     public ResponseEntity<Object> getNotificationById(HttpServletRequest request, @PathVariable String idNotification) {
//         String sessionToken = request.getHeader("Token");
//         HTTPCode httpCode = HTTPCode.OK;
//         try {
//             if (loginService.checkSessionAlive(sessionToken)) {
...
//                             .readNotifikasisByUser(loginService.getLoginSession(sessionToken).getId(), idNotification);
//                     if (notifikasiOptional.isPresent()) {
//                         Notifikasi notifikasi = notifikasiOptional.get();
//                         if (notifikasi.getIdUser().getId().equals(loginService.getLoginSession(sessionToken).getId())) {
//                             data = Map.of(
//                                     "id", notifikasi.getId(),
...
//                                     "idAgenda", notifikasi.getIdAgenda() == null ? "" : notifikasi.getIdAgenda().getId(),
//                                     "idReminder", notifikasi.getIdReminder() == null ? "" : notifikasi.getIdReminder().getId());
//                         } else {
//                             httpCode = HTTPCode.BAD_REQUEST;
